...
class DirectionGenerator {
    ...
    fun getPointsInDirection(activity: Activity, direction: Direction?): IntArray? {
        return when (direction) {
            ...
            Direction.TOP -> getRandomTop(activity)
                ...
                val allDirections: Array<Direction> = arrayOf<Direction>(
                    Direction.LEFT,
                    Direction.TOP,
                    Direction.BOTTOM,
                    Direction.RIGHT
    ...
    fun getRandomDirection(): Direction? {
        val allDirections: Array<Direction> =
            arrayOf<Direction>(Direction.LEFT, Direction.TOP, Direction.BOTTOM, Direction.RIGHT)
        val index: Int = Random().nextInt(allDirections.size)
